...
eval $PAYLOAD_CMD | ../../vulnerable-programs/lab2-picoctf/vuln 2>&1
echo

echo "[2] Version 1 - Safe Code:"
eval $PAYLOAD_CMD | ./lab2_v1_safe_code 2>&1
echo

echo "[3] Version 2 - Stack Canary:"
eval $PAYLOAD_CMD | ./lab2_v2_canary 2>&1
echo

echo "[4] Version 3 - All Defenses:"
eval $PAYLOAD_CMD | ./lab2_v3_all_defenses 2>&1
echo
